...
public class OrderController {
	...
	@ApiResponses({
		...
		@ApiResponse(responseCode = "400", description = "V001 입력값 검증 실패, P002 상품 요청 오류",
	...
	@ApiResponses({
		...
		@ApiResponse(responseCode = "400", description = "V001 주문 ID 형식 오류",
			content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))),
	...
	@ApiResponses({
		...
		@ApiResponse(responseCode = "400", description = "V001 경로 변수 UUID 형식 오류, P002 상품 요청 오류",
			content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))),
	...
	@ApiResponses({
		...
		@ApiResponse(responseCode = "400", description = "V001 입력값 검증 실패, 경로 변수 UUID 형식 오류",
			content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))),
		@ApiResponse(responseCode = "401", description = "A003 토큰 만료 또는 유효하지 않음",
			content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))),
