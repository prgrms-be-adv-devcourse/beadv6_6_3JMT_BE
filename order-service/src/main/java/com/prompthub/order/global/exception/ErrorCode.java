...
public enum ErrorCode implements com.prompthub.exception.ErrorCode {
    ...
    ORDER_REFUND_IN_PROGRESS(HttpStatus.CONFLICT, "O018", "해당 주문의 환불 요청이 진행 중입니다."),
    ORDER_CONCURRENT_MODIFICATION(HttpStatus.CONFLICT, "O019", "주문이 동시에 변경되어 요청을 처리할 수 없습니다."),
