...
public enum ErrorCode implements com.prompthub.exception.ErrorCode {
    ...
    ORDER_REFUND_NOT_ALLOWED(HttpStatus.CONFLICT, "O016", "환불할 수 없는 주문 상품입니다."),
    ORDER_REFUND_REQUEST_CONFLICT(HttpStatus.CONFLICT, "O018", "환불 요청이 현재 상태와 충돌합니다."),
    ORDER_PAYMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "O019", "주문 결제 정보를 찾을 수 없습니다."),
    ORDER_REFUND_EVENT_MISMATCH(HttpStatus.CONFLICT, "O020", "환불 결과 이벤트 정보가 요청과 일치하지 않습니다."),
