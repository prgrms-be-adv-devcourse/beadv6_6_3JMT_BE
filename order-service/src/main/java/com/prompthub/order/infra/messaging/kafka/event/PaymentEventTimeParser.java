...
public final class PaymentEventTimeParser {
	...
	public static LocalDateTime parseRequired(String value) {
	...
	public static LocalDateTime parseOrElse(String value, LocalDateTime fallback) {
