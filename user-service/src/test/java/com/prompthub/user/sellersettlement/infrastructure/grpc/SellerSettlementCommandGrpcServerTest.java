...
class SellerSettlementCommandGrpcServerTest {

    @Mock
    private RegisterSellerSettlementUseCase useCase;

    private SellerSettlementCommandGrpcServer server;

    @BeforeEach
    void setUp() {
        server = new SellerSettlementCommandGrpcServer(
                useCase,
                new SellerSettlementCommandGrpcRequestMapper(),
