...
class SellerSettlementAnalysisGrpcServerTest {

    @Mock
    private SellerSettlementAnalysisUseCase useCase;

    private SellerSettlementAnalysisGrpcServer server;

    @BeforeEach
    void setUp() {
        server = new SellerSettlementAnalysisGrpcServer(
                useCase, new SellerSettlementAnalysisGrpcResponseMapper());
    }
