...
public class SellerSettlementCommandGrpcServer
    ...
    private final SellerSettlementCommandGrpcRequestMapper requestMapper;
    private final SellerSettlementCommandGrpcResponseMapper responseMapper;
