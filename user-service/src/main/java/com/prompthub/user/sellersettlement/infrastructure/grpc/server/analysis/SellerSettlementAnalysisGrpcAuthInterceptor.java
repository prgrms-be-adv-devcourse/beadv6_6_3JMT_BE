...
@Component
public class SellerSettlementAnalysisGrpcAuthInterceptor implements ServerInterceptor {
    ...
    public SellerSettlementAnalysisGrpcAuthInterceptor(
            SellerSettlementAnalysisGrpcSecurityProperties properties) {
