...
|------|--------|------|
| - [x] | GET | `/admin/users` |
| - [x] | PATCH | `/admin/users/{userId}/status` |
| - [x] | GET | `/admin/stats/users` |

### 관리자 — 판매자 심사 (Admin)

| 구현 | 메서드 | 경로 |
|------|--------|------|
| - [x] | GET | `/admin/sellers/register` |
| - [x] | PATCH | `/admin/sellers/register/{registerId}/approve` |
| - [x] | PATCH | `/admin/sellers/register/{registerId}/reject` |
