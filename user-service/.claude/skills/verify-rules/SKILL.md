...
| --- | --- | --- | --- |
| clean-architecture | `user-service/.claude/rules/clean-architecture.md` | 변경 파일 | 클린아키텍처 |
| domain-model | `user-service/.claude/rules/domain-model.md` | 변경 파일 | 도메인 모델 |
| controller-exception | `user-service/.claude/rules/controller-exception.md` | 변경 파일 | Controller/예외 |
| code-style | `user-service/.claude/rules/code-style.md` | 변경 파일 | 코드 스타일 |
| swagger | `user-service/.claude/rules/swagger.md` | 변경 파일 | Swagger |
| git-convention | `user-service/.claude/rules/git-convention.md` | 브랜치명 + 커밋 메시지 | Git 컨벤션 |
| security | `user-service/.claude/rules/security.md` | 변경 파일 + diff(추가 라인) + .gitignore | 보안 |
...
RULE_FILE: user-service/.claude/rules/clean-architecture.md
INPUT (CHANGED_FILES):
...
RULE_FILE: user-service/.claude/rules/git-convention.md
