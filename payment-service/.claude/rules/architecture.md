...
- **application.usecase**: Input Boundary. `presentation`이 주입받아 UseCase 인터페이스를 호출하고, 같은 패키지의 Interactor 구현체가 처리한다.
...
| `infrastructure` | application.gateway.*, application.dto, domain.model | presentation |
