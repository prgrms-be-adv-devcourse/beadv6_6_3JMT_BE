package com.prompthub.admin.order.controller;

import com.prompthub.admin.order.service.OrderService;
...
class OrderControllerTest {
	...
	void 전체_주문_목록을_조회한다() throws Exception {
		...
		when(orderService.getOrders(eq(new com.prompthub.admin.order.dto.request.OrderSearchCondition("ALL", 1, 20).resolve())))
