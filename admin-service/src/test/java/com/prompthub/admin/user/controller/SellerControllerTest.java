...
class SellerControllerTest {
	...
	void 판매자_신청_목록을_조회한다() throws Exception {
		...
		when(sellerService.listSellerRegisters(any()))
	...
	void 판매자_신청을_승인한다() throws Exception {
		...
		when(sellerService.approve(any())).thenReturn(new SellerRegisterReviewResult(
	...
	void 판매자_신청을_반려한다() throws Exception {
		...
		when(sellerService.reject(any())).thenReturn(new SellerRegisterReviewResult(
