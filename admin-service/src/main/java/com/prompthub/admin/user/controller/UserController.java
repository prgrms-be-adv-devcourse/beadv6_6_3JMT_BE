...
import com.prompthub.admin.user.dto.request.ChangeUserRoleRequest;
import com.prompthub.admin.user.dto.request.ChangeUserStatusRequest;
import com.prompthub.admin.user.dto.response.UserResponse;
import com.prompthub.admin.user.dto.response.UserRoleResponse;
import com.prompthub.admin.user.dto.response.UserStatsResponse;
import com.prompthub.admin.user.dto.response.UserStatusResponse;
...
public class UserController {
	...
	public ApiResult<UserStatsResponse> getUserStats() {
		UserStatsResult result = userService.getUserStats();
	...
	public ApiResult<UserStatusResponse> changeUserStatus(
		...
		UserStatusResult result = userService.changeUserStatus(command);
	...
	public ApiResult<UserRoleResponse> changeUserRole(
		...
		UserRoleResult result = userService.changeUserRole(command);
