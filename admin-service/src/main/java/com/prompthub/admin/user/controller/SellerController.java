...
import com.prompthub.admin.user.service.SellerService;
import com.prompthub.admin.user.entity.enums.SellerRegisterStatus;
import com.prompthub.admin.user.dto.request.RejectSellerRegisterRequest;
import com.prompthub.admin.user.dto.response.SellerRegisterResponse;
import com.prompthub.admin.user.dto.response.SellerRegisterReviewResponse;
...
public class SellerController {
	...
	public ApiResult<SellerRegisterReviewResponse> approveSeller(
		...
		SellerRegisterReviewResult result = sellerService.approve(new ApproveSellerCommand(registerId));
	...
	public ApiResult<SellerRegisterReviewResponse> rejectSeller(
		...
		SellerRegisterReviewResult result = sellerService.reject(
