...
import com.prompthub.ai.settlement.application.port.SellerSettlementQuery.PayoutStatusResult;
import com.prompthub.ai.settlement.application.port.SellerSettlementQuery.SettlementComparisonResult;
import com.prompthub.ai.settlement.application.port.SellerSettlementQuery.SettlementSummaryResult;
import com.prompthub.ai.settlement.application.port.SellerSettlementQuery.WeeklyBreakdownResult;
...
@Slf4j
@Component
public class SettlementAnalysisTools {

    private final SellerSettlementQuery query;
    private final ToolExecutionGuard executionGuard;
    private final MeterRegistry meterRegistry;

    public SettlementAnalysisTools(
            SellerSettlementQuery query,
    ...
    public SettlementSummaryResult getSettlementSummary(
        ...
        return execute("get_settlement_summary", context,
                actorId -> query.getSummary(actorId, periodType, period));
    }
    ...
    public SettlementComparisonResult compareSettlementPeriods(
        ...
        return execute("compare_settlement_periods", context,
                actorId -> query.comparePeriods(actorId, periodType, currentPeriod, comparisonPeriod));
    }
    ...
    public WeeklyBreakdownResult getWeeklySettlementBreakdown(
        ...
        return execute("get_weekly_settlement_breakdown", context,
                actorId -> query.getWeeklyBreakdown(actorId, month));
    }
    ...
    public PayoutStatusResult getPayoutStatus(
        ...
        return execute("get_payout_status", context,
                actorId -> query.getPayoutStatus(actorId, settlementMonth));
    }
