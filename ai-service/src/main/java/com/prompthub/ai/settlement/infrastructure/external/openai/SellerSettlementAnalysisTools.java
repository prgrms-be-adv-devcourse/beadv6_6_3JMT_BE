package com.prompthub.ai.settlement.infrastructure.external.openai;

import com.prompthub.ai.global.exception.AiException;
import com.prompthub.ai.settlement.application.client.user.SellerSettlementAnalysisClient;
import com.prompthub.ai.settlement.application.client.user.SellerSettlementAnalysisClient.DashboardSummaryResult;
import com.prompthub.ai.settlement.application.client.user.SellerSettlementAnalysisClient.PayoutStatusResult;
import com.prompthub.ai.settlement.application.client.user.SellerSettlementAnalysisClient.SettlementComparisonResult;
import com.prompthub.ai.settlement.application.client.user.SellerSettlementAnalysisClient.SettlementSummaryResult;
import com.prompthub.ai.settlement.application.client.user.SellerSettlementAnalysisClient.WeeklyBreakdownResult;
...
public class SellerSettlementAnalysisTools {
    ...
    private final SellerSettlementAnalysisClient analysisClient;
    private final ToolExecutionGuard executionGuard;
    private final MeterRegistry meterRegistry;

    public SellerSettlementAnalysisTools(
            SellerSettlementAnalysisClient analysisClient,
    ...
    public DashboardSummaryResult getSettlementDashboardSummary(ToolContext context) {
        return execute("get_settlement_dashboard_summary", context,
                analysisClient::getDashboardSummary);
    }
    ...
    public SettlementSummaryResult getSettlementSummary(
        ...
        return execute("get_settlement_summary", context,
                actorId -> analysisClient.getSummary(actorId, periodType, period));
    }
    ...
    public SettlementComparisonResult compareSettlementPeriods(
        ...
        return execute("compare_settlement_periods", context,
                actorId -> analysisClient.comparePeriods(actorId, periodType, currentPeriod, comparisonPeriod));
    }
    ...
    public WeeklyBreakdownResult getWeeklySettlementBreakdown(
        ...
        return execute("get_weekly_settlement_breakdown", context,
                actorId -> analysisClient.getWeeklyBreakdown(actorId, month));
    }
    ...
    public PayoutStatusResult getPayoutStatus(
        ...
        return execute("get_payout_status", context,
                actorId -> analysisClient.getPayoutStatus(actorId, settlementMonth));
    }
