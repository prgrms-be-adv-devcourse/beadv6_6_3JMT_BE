...
public class SpringAiSettlementAgentAdapter implements SettlementAgentGateway {
    ...
    private final SettlementConversationHistorySelector historyTokenSelector;
    ...
    public SpringAiSettlementAgentAdapter(
            ChatModel chatModel,
            ToolCallingManager toolCallingManager,
            SellerSettlementAnalysisTools analysisTools,
            SettlementConversationHistorySelector historyTokenSelector,
