...
class RedisSettlementRunEventPubSubIntegrationTest {
    ...
    private RedisSettlementRunEventPublisher publisher;
    ...
    void setUp() {
        ...
        publisher = new RedisSettlementRunEventPublisher(redisTemplate, objectMapper);
    }
    ...
    private RedisMessageListenerContainer listenerContainer(RedisSettlementRunEventSubscriber subscriber) {
